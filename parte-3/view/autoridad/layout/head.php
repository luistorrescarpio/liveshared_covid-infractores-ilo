    ...
    <div class="container"> <a class="navbar-brand text-primary" href="<?=$view?>/autoridad/index.php">
      ...
      <div class="collapse navbar-collapse" id="navbar5">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item"> <a class="nav-link text-secondary" href="individuo_registro.php" style="font-weight: bold;"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Nuevo Individuo</a> </li>
        </ul> 
